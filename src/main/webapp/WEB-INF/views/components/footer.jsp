...
<footer id="footer" class="footer accent-background">
  ...
  <div class="container footer-top">
    <div class="row gy-4" style="flex-wrap: nowrap">
      ...
      <div class="col-lg-2 col-6 footer-links" >
        <h4 style="text-align: left">LIÊN KẾT HỮU ÍCH</h4>
        <ul>
      ...
      <div class="col-lg-2 col-6 footer-links">
        ...
        <ul>
          ...
          <li><a href="#">Dịch vụ truyền thông BDS</a></li>
      ...
      <div class="col-lg-3 col-md-12 footer-contact text-center text-md-start">
        <h4 style="text-align: left">LIÊN HỆ VỚI CHÚNG TÔI</h4>
  ...
  <div class="container copyright text-center mt-4">
    <p>Công ty Cổ Phần công nghệ VIP Việt Nam </p>
    <div class="credits">
